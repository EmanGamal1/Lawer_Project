<template>
  <login-layout title="تغييــر كلمــة المــرور">
    <form class="formForget" @submit.prevent="resetPassword">
      <label for="phone" class="resetPassLabel">رقـم الهــاتف</label>
      <input
        type="text"
        class="form-control"
        v-model="phone"
      ...
      <label for="phone_code" class="resetPassLabel">كود البلـــد</label>
      <input
        type="text"
        class="form-control"
        v-model="phone_code"
      ...
      <label for="code" class="resetPassLabel">الكــود</label>
      <input
        type="text"
        class="form-control"
        v-model="code"
      ...
      <label for="password" class="resetPassLabel">كلمــة المرور</label>
      <input
        type="password"
        class="form-control"
        v-model="password"
      ...
      <label for="password_confirmation" class="resetPassLabel"
        >تأكيـد كلمــة المرور</label
      >
      <input
        type="password"
        class="form-control"
        ...
        placeholder="تأكيـد كلمــة المرور"
      />
      <span class="errors">{{ confirmPasswordErrorMessage }}<br /></span>
      <span class="invalidResetPassword errors" v-if="showErrorSpan">{{
...
export default {
  ...
  setup(props) {
    ...
    return {
      phone, phone_code, code, password, password_confirmation,
      showSuccessModal, showErrorSpan, resetPassword, closeModal,
      showErrorSpan, phoneErrorMessage,
      phoneCodeErrorMessage, codeErrorMessage,
      passwordErrorMessage, confirmPasswordErrorMessage,
      phoneBlur, codeBlur,
      passwordBlur, confirmPasswordBlur,
      phoneCodeBlur, showErrorSpanMessage,
    };
  },
};
</script>
